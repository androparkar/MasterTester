  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Teacher_profile.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="./Class_management.php" target="_blank" rel="noopener noreferrer">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="./Subject_management.php" target="_blank" rel="noopener noreferrer">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="./Exam_management.php" target="_blank" rel="noopener noreferrer">
